...
OUTPUT_FOLDER = "plots/marginalisation/comparison/FFT/"
# name = "EUCLID2012_AP0-7bins"
# uFM = np.loadtxt(open(INPUT_FOLDER+"FMuncorr_"+name+"-W0.csv","rb"),delimiter=" ",skiprows=0)
# wFM = np.loadtxt(open(INPUT_FOLDER+"FMuncorr_"+name+"-W1.csv","rb"),delimiter=" ",skiprows=0)
# cFM = np.loadtxt(open(INPUT_FOLDER+"FMcorr_"+name+".csv","rb"),delimiter=" ",skiprows=0)

name = "EUCLID2012_AP0"
wFM7 = np.loadtxt(open(INPUT_FOLDER+"FMuncorr_"+name+"-7bins-W1.csv","rb"),delimiter=" ",skiprows=0)
wFM14 = np.loadtxt(open(INPUT_FOLDER+"FMuncorr_"+name+"-14bins-W1.csv","rb"),delimiter=" ",skiprows=0)
...
# ellipses, ranges = compute_ellipses_allVars([wFM,cFM,uFM],3)
# maxRange = max_range(ranges)
# print_ellipses_allVars(ellipses,maxRange,"EUCLID2012_AP0-7bins",["Top hat","Top hat + correlations","Standard"],"upper left",['g','b','r'],2,13)
...
ellipses, ranges = compute_ellipses([wFM14,wFM7],var1,var2)
maxRange = max_range(ranges)
print_ellipses(ellipses,maxRange,var1,var2,"WF_compare_bins",["14 bins","7 bins"],"upper left",['g','b','r'])
