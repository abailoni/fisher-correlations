...
# Modification: added support for **args in the function

import numpy as np

def sample_function(func, points, tol=0.05, min_points=16, max_level=16,
                    sample_transform=None,**args):
    """
    ...
    x, y = _sample_function(func, points, values=None, mask=None, depth=0,
                            ...
                            sample_transform=sample_transform, **args)
...
def _sample_function(func, points, values=None, mask=None, tol=0.05,
    ...
    if values is None:
        values = np.atleast_2d(func(points,**args))
    ...
    x_c = .5*(x_a + x_b)
    y_c = np.atleast_2d(func(x_c,**args))
